# led-breakout-board
A simple 3-channel LED breakout board designed in KiCad for easy connection and control of LEDs with a microcontroller.
...
- Common GND
- Header connector for easy connection
...
![PCB Layout](images/Screenshot(40).png)
